...
public class BookOrderControllerTest {
    ...
    private BookOrderDTO sampleBookOrder;

    @BeforeEach
    void setUp() {
        sampleBookOrder = new BookOrderDTO();
    ...
    void testCreateBookOrder() throws Exception {
        when(bookOrderService.saveOrder(any(BookOrderDTO.class))).thenReturn(sampleBookOrder);
        ...
        verify(bookOrderService, times(1)).saveOrder(any(BookOrderDTO.class));
    }
